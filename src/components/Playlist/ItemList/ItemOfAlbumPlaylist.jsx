...
function ItemOfAlbumPlaylist({ ordinalNumber, imgMusic, nameMusic, nameArt, nameAlbum, dateAdd, time, onItemClick, linkMp3, isActive }) {
...
export default ItemOfAlbumPlaylist;